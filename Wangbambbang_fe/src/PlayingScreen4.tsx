...
type PlayingScreenNavigationProp = StackNavigationProp<
  ...
  'Playing4'
>;
type PlayingScreenRouterProp = RouteProp<RootStackParamList, 'Playing4'>;
...
const PlayingScreen4: React.FunctionComponent<Props> = ({
  navigation,
  route,
}) => {
